...
app.add_middleware(
    CORSMiddleware, 
    allow_origins=["http://127.0.0.1:5500","https://isa-project-frontend.netlify.app", "https://isa-project-frontend.onrender.com/", "https://isa-frontend-285df755bfe6.herokuapp.com"],  # Temporarily allow all origins for testing
